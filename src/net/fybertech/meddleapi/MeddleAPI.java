...
public class MeddleAPI 
{
	...
	public static List<String> dynaMods = new ArrayList<String>();
	...
	{
		LOGGER.info("[MeddleAPI] PreInit: " + obj);
		mainObject = obj;
	}
	...
	public static void registerItem(int itemID, String itemName, ItemTest item)
	{
		if (registerItemMethod == null) 
		{
			...
			try {
				itemClass = MeddleAPI.class.forName(itemClassName);
			} 
